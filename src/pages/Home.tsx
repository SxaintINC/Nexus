    ...
    style.textContent = `
      ...
      *, *::before, *::after { box-sizing: border-box; }
      ...
      @media (max-width: 900px) {
        ...
        /* Stage-block (stages 2 & 4) gets even tighter; on stage 3 still works */
        .r-stage-block { max-width: 280px !important; }
        .r-stage-block h2 { font-size: clamp(24px, 3.4vw, 36px) !important; }
        .r-stage-block p { font-size: 14px !important; line-height: 1.55 !important; }
      ...
      @media (max-width: 768px) {
        ...
        /* Choreography — kill side text overlays + size hero text down */
        .r-stage-block { display: none !important; }
        .r-hero-text {
          left: 6% !important;
          right: 6% !important;
          bottom: auto !important;
